...
export default function Home() {
  ...
  return (
    ...
    <main className='h-full w-full py-5 px-10 relative'>
      <Image className="object-cover w-full h-full opacity-40" src={"https://images.pexels.com/photos/2850438/pexels-photo-2850438.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"} alt='city view' width={800} height={800}>
